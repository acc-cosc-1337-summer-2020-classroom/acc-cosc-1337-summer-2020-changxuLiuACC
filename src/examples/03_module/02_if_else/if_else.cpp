...
//global variables are declared up here and are available in all functions and all files this is linked to
...
std::string get_generation(int year)
{
    ...
    //this is discouraged in software engineering as it's hard to maintain/test
